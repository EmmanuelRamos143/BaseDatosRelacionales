...
Notamos que el primer modelo con menor AIC (Akaike information criterion), es el elegido por la libreria, se procede a revisar el modelo sugerido como el mejor.

_**Bevans, R. (2022, 18 noviembre). Akaike Information Criterion | When & How to Use It (Example). Scribbr. Recuperado 3 de diciembre de 2022, de https://www.scribbr.com/statistics/akaike-information-criterion/ **_
...
_**Caporal, J. (2022, 29 julio). Average House Price by State in 2022. The Motley Fool. https://www.fool.com/the-ascent/research/average-house-price-state/ **_
...
En este proyecto integrador , se tuvieron muy buenos resultados con respecto trabajo realizado, la parte tanto exploratoria de datos como su analisis y pruebas de bondad y asjute tuvieron sentido, la unica parte del modelo que no se tuvo un resultado deseado fue el desmpeno del modelo ya que fue un resultado moderado a bajo, dado que este modelo fue solo una regression simple de multiples variables predictivas y se encontro el mejor modelo , el resultado general es bueno ya que se cumplieron supuestos del modelo , no se encontro multicolinealidad en ninguna de las variables lo cual habla de un buen modelo de datos, con respecto a las pruebas de bondad y de ajuste de aplicadas se obtuvo resultados que tenian sentido con resptecto a la parte grafica y complemento la parte de pruebas de hipotesis no parametricas las cuales se obtuvieron resultados muy buenos en los cuales comparamos con valores de referencia reales lo cual nos habla de un buen analisis.
...
_**[1] Soetewey. (2020, 11 agosto). Outliers detection in R. Stats and R. Recuperado 3 de diciembre de 2022, de https://statsandr.com/blog/outliers-detection-in-r/ **_



_**[2] Bevans, R. (2022, 18 noviembre). Akaike Information Criterion | When & How to Use It (Example). Scribbr. Recuperado 3 de diciembre de 2022, de https://www.scribbr.com/statistics/akaike-information-criterion/ **_



_**[3] Grothendieck, G. (2021, 17 febrero). Run all posible combination of linear regression with 2 independent variables. Stack Overflow. Recuperado 3 de diciembre de 2022, de https://stackoverflow.com/questions/66236896/run-all-posible-combination-of-linear-regression-with-2-independent-variables **_



_**[4]J, J. (2020). R: Exhaustive feature selection. Recuperado 3 de diciembre de 2022, de https://search.r-project.org/CRAN/refmans/ExhaustiveSearch/html/ExhaustiveSearch.html **_



_**[5] A, A. (2022). Prueba de rango con signo de Wilcoxon en programación R – Acervo Lima. acervolima.com. Recuperado 3 de diciembre de 2022, de https://es.acervolima.com/prueba-de-rango-con-signo-de-wilcoxon-en-programacion-r/ **_



_**[6] R: Overview of the top exhaustive search results. (2022). Recuperado 3 de diciembre de 2022, de https://search.r-project.org/CRAN/refmans/ExhaustiveSearch/html/resultTable.html **_



_**[7] Kruskal-Wallis Test in R - Easy Guides - Wiki - STHDA. (s. f.). http://www.sthda.com/english/wiki/kruskal-wallis-test-in-r **_



_**[8] Caporal, J. (2022, 29 julio). Average House Price by State in 2022. The Motley Fool. https://www.fool.com/the-ascent/research/average-house-price-state/ **_
